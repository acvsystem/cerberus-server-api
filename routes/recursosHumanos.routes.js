...
const router = Router();
import { generarCodigo, regHorasExtras, regPapeleta, listPapeleta, seachPapeleta, recalcularHorasExtras } from '../controllers/csPapeletas.js';

router.post('/pap/gen_codigo_pap', generarCodigo);
router.post('/pap/horas_extras', regHorasExtras);
router.post('/pap/horas_extras/recalcular', recalcularHorasExtras);
